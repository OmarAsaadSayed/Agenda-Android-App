...
import com.example.agenda.adapters.NotesAdapter;
...
public class AllNotes extends AppCompatActivity implements NotesListener {
        ...
        addimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivityForResult(
                        new Intent(getApplicationContext(),Note_Edit.class),
